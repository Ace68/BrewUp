...
public sealed class BeerAvailabilityChecked : DomainEvent
{
	...
	public BeerAvailabilityChecked(BeerId aggregateId, Stock stock, Availability availability, ProductionCommitted productionCommitted, SalesCommitted salesCommitted, SupplierOrdered supplierOrdered) : base(aggregateId)
	{
		BeerId = aggregateId;
		Stock = stock;
